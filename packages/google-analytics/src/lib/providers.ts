 ...
 *
 * You should provide a valid Google TrackingCode. This code will be provided to the entire application.
 * This provider should be a dependency on the highest level module of the application, i.e. AppConfig in most use cases.
 *
